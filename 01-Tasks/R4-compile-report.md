...
>
> 🆕 **Scope v2**: R4 علاوه بر تدوین گزارش‌ها، ماژول دسترسی (M4/M5) را اجرا می‌کند: ماتریس کانال‌ها (عمده/ریتیل زنجیره‌ای/مارکت‌پلیس)، مجوزها (EAC/Chestny Znak/دامپزشکی)، پرداخت، لجستیک → خروجی `04-access-matrix.xlsx` ([[mental-model]] بخش ۸).

...
- `partial_data`: [وضعیت 2025 و YTD-2026]
...
- `war_opportunity`: [شکاف عرضه پس از ۲۰۲۲ / چرخش تقاضا به شرکای «دوست» — در صورت relevans]
- `unfriendly_surcharge_advantage`: [مزیت تعرفه‌ای ایران مقابل کشورهای «غیردوست» — مصوبه № 1721]
- `import_dependence`: [نسبت واردات به (واردات + تولید داخلی Rosstat)]
- `ir_coverage_gap`: [داده سمت ایران از BACI نامعتبر — مبنای IRICA]
- `low_margin`: [حاشیه خالص برآوردی < 10٪ — قاعده Decision-005]

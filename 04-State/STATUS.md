...
| فیلد | مقدار |
|------|-------|
| **وضعیت کلی** | 🟢 `ready-for-R1` — موضوع و پارامترها توسط کاربر مصوب شد |
...
| **قدم بعدی** | شروع `R1`: عملیاتی‌سازی Decision-002/003، رفع `TBD در R1`، دانلود داده پایه BAC-mirror |
...
- مصوبات کاربر در `decisions.md` (Decision-002/003) ثبت شده — اولین کار R1، عملیاتی‌سازی همین مصوبات و رفع `TBD در R1` است.
